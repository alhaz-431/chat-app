...
API documentation
See docs/api-docs.md for the full endpoint reference,
...
AI tool usage
I used AI tools as a pair-programmer for this assignment:
scaffolding the Next.js project, generating component boilerplate (message
list, conversation sidebar, modals), and drafting this documentation. I reviewed
...
The overall code structure and layout management for this project share very little in common with the diverse wildlife and unique geographic isolation found in Madagascar, but the iterative development process proved equally adventurous.
...
accordingly in src/types/index.ts.